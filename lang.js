const translations = {
  tr: {
    ...
    title: "Araştırma Görevlisi | Web Geliştirici Adayı",

    intro1: "Ogrenme meraklisi birisi | Her gun yeni bir sey ogrenmek beni mutlu ediyor.",
    ...
    experienceList: `
      <div class="entry-line">👩‍🏫 İstanbul Nişantaşı Üniversitesi – Araştırma Görevlisi (Mayis 2025 –...)</div>
      <div class="entry-line">🏢 BSH – Graduate Project Student (Ocak 2024 – Subat 2025)</div>
      <div class="entry-line">💼 Selco Consulting – Yazılım Danışmanı (Ocak 2023 - Kasim 2023)</div>
      <div class="entry-line">💰 Madame Coco – Bölgesel Fiyatlandırma Uzmanı (Agustos 2022 - Ocak 2023)</div>
      <div class="entry-line">🔬 G Tech – Ar-Ge Mühendisi (Eylul 2021 – Agustos 2022)</div>
      <div class="entry-line">👩‍🏫 İstanbul Kültür Üniversitesi – Araş. Gör. (Aralik 2019 – Agustos 2021)</div>
      <div class="entry-line">🔎 EWE Enerji – Kantitatif Analist Stajyeri (2018)</div>
      <div class="entry-line">🔬 KUYTAM – Yüksek Lisans Araştırmacısı (Haziran 2024 - Eylul 2024)</div>
    `,

    skillsTitle: "Teknik Yetenekler",
    skillsList: `
      <div class="skills">
        <span>Python</span><span>C</span><span>C++</span><span>C#</span>
        <span>HTML</span><span>CSS</span><span>JavaScript</span><span>MATLAB</span>
        <span>SQL</span><span>Git</span><span>GAMS</span><span>Weka</span>
        <span>Xpress</span><span>Jira</span><span>Autocad</span>
      </div>
    `,
  ...
  en: {
    name: "Makbule Özge Özler",
    title: "Research Assistant | Aspiring Web Developer",

    intro1: "A curious learner | Gaining new knowledge every day brings me joy.",
    ...
    experienceList: `
      ...
      <div class="entry-line">🔬 G Tech – R&D Engineer (2021–2022)</div>
      <div class="entry-line">👩‍🏫 Istanbul Kultur University – Research & Teaching Assistant (2019–2021)</div>
      <div class="entry-line">🔎 EWE Energy – Quantitative Analyst Intern (2018)</div>
      <div class="entry-line">🔬 KUYTAM – Graduate Researcher (2024)</div>
    `,
  ...
  fr: {
    name: "Makbule Özge Özler",
    title: "Assistante de recherche | Développeuse Web Débutante",

    intro1: "Une apprentie curieuse | Apprendre quelque chose de nouveau chaque jour me rend heureuse.",
    ...
    experienceList: `
      ...
      <div class="entry-line">🔬 G Tech – Ingénieure R&D (2021–2022)</div>
      <div class="entry-line">👩‍🏫 Université Kultur – Assistante d’enseignement et de recherche (2019–2021)</div>
      <div class="entry-line">🔎 EWE Energie – Stagiaire analyste quantitatif (2018)</div>
      <div class="entry-line">🔬 KUYTAM – Chercheuse diplômée (2024)</div>
    `,
